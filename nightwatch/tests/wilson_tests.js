    ...
    */
    ...
    "Enter Wanted: Tests for '.'": browser => {
        ...
        */
        ...
        /* BUG: INVALID PERIODS ARE NOT CAUSING ERRORS
    ...
    'Enter Wanted: Alphabetical Characters Test': browser => {
        ...
        //enters input fields
        functions.enterFields(selectors.fields, data.alphabetical.input, browser)
        browser
        ...
        //checks that each error message that is listed in the data has been printed
        browser.verify.containsText(selectors.messages.errorList, data.alphabeticalCharacters.output.errorList['hdr'])        browser.verify.containsText(selectors.messages.errorList, data.alphabeticalCharacters.output.errorList['hgt'])
